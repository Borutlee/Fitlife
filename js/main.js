            ...
            exercises: [
                {
                    ...
                    time: 30, // 💡 تمت إضافة الوقت بالدقائق
                ...
                },
                {
                    ...
                    time: 45, // 💡 تمت إضافة الوقت بالدقائق
            ...
            exercises: [
                {
                    ...
                    time: 15, // 💡 تمت إضافة الوقت بالدقائق (يشمل عدة مجموعات وراحة)
                    src: "imgs/squat.webp"
                },
                {
                    ...
                    time: 10, // 💡 تمت إضافة الوقت بالدقائق (يشمل عدة مجموعات وراحة)
            ...
            exercises: [
                {
                    ...
                    time: 5, // 💡 تمت إضافة الوقت بالدقائق (يشمل كلا الجانبين)
                ...
                },
                {
                    ...
                    time: 3, // 💡 تمت إضافة الوقت بالدقائق
            ...
            if (selectedInfo) {
                ...
                selectedInfo.exercises.forEach((exercise, index) => {
                    if (trainingimg[index]) {
                        ...
                        time[index].textContent = exercise.time + " دقيقة";
                    }
                });
            }
